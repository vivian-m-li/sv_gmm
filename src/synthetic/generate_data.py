...
def generate_mapped_pairs_for_sv(
    ...
    for _ in range(n_pairs):
        ...
        # use a normal distribution with mean=0 because we want the jitter to be centered around the mode breakpoints
...
if __name__ == "__main__":
    generate_and_split_sample_reads(
        1,
        [(10000, 10300), (10050, 10350)],
        insert_size_file="data/1kg/insert_sizes.csv",
        model_params={
            "d_threshold": 550,
            "r_threshold": 0.6,
            "max_penalty": 537,
